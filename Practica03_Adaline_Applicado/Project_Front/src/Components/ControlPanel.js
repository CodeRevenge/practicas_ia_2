      ...
      <div className="control-panel">
        <div className="classes-container" >
          <div className="class1">
            ...
            <div ref={(redClass) => {this.redClass = redClass}} className="class red active" onClick={this.setActive} >
              <img className="class-image red" width="150" height="150" src={rectangle} alt=""></img>
            </div>
          </div>
          <div className="class2">
            <p>Clase 2</p>
            <div ref={(blueClass) => {this.blueClass = blueClass}} className="class blue" onClick={this.setActive} >
              <img className="class-image blue" width="150" height="150" src={circle} alt=""></img>
            </div>
          </div>
        </div>
        <div className="inputs-container">
          ...
          <div className="error-input">
            <p>Min. Error</p>
            <input type="text" onChange={this.props.onMinErrorInput} value={this.props.errorInput} placeholder=".05"></input>
          </div>
        </div>
        <div className="buttons-container">
          ...
          <div className="inicializar-container">
            <input onClick={this.props.sendPoints} className="button-entrenar perceptron" type="submit" value="Perceptrón"></input>
            <input onClick={this.props.sendPoints} className="button-entrenar adaline" type="submit" value="Adaline"></input>
          </div>
        </div>
      </div>
    );
