...
"}")
        ...
        self.classes_cout.setMaximum(100)
        ...
        self.btn_train.setGeometry(QtCore.QRect(10, 530, 531, 71))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.layer_count.setMaximum(100)
        ...
        self.btn_donut.setGeometry(QtCore.QRect(10, 440, 71, 71))
        self.btn_donut.setObjectName("btn_donut")
        self.btn_xor = QtWidgets.QPushButton(self.control_box)
        self.btn_xor.setGeometry(QtCore.QRect(100, 440, 71, 71))
        self.btn_xor.setObjectName("btn_xor")
        self.btn_map = QtWidgets.QPushButton(self.control_box)
        self.btn_map.setGeometry(QtCore.QRect(190, 440, 71, 71))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_xor.setText(_translate("MainWindow", "XOR"))
