...
"}")
        ...
        self.btn_dona = QtWidgets.QPushButton(self.control_box)
        self.btn_dona.setGeometry(QtCore.QRect(10, 440, 51, 51))
        self.btn_dona.setObjectName("btn_dona")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_dona.setText(_translate("MainWindow", "Dona"))
