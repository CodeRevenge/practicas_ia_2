...
"}")
        ...
        self.gridLayout_5.addWidget(self.btn_train, 4, 0, 1, 4)
        ...
        self.inp_grid_size.setMinimumSize(QtCore.QSize(0, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
